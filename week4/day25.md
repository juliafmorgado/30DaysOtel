# Day 25 – When Things Go Wrong: Handling Production Issues at Scale

Yesterday we learned to find individual missing spans and broken context propagation by debugging distributed traces. Over the past few days, we've mastered systematic debugging:

- **Day 22:** Debugging the Collector (infrastructure focus) - "Is the Collector itself working?"
- **Day 23:** Troubleshooting missing data (end-to-end pipeline focus) - "Where is my data getting lost?"
- **Day 24:** Debugging distributed traces (trace completeness focus) - "Why is this specific span missing?"
- **Day 25:** System reliability under load (system-wide focus) - "How do we keep the whole system working when overwhelmed?"
...
> [!IMPORTANT]
>
> Don't confuse this with [Day 24](./day24.md) where we learned about missing spans (debugging problem). The focus there was "Why don't I see spans that should be there?". There, the cause was configuration issues, broken instrumentation, network problems.
>
